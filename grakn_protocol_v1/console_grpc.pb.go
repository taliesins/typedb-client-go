...
func (c *kGMSConsoleClient) UserManagement(ctx context.Context, opts ...grpc.CallOption) (KGMSConsole_UserManagementClient, error) {
	stream, err := c.cc.NewStream(ctx, &_KGMSConsole_serviceDesc.Streams[0], "/KGMSConsole/UserManagement", opts...)
	if err != nil {
		return nil, err
	}
...
func RegisterKGMSConsoleServer(s grpc.ServiceRegistrar, srv KGMSConsoleServer) {
	s.RegisterService(&_KGMSConsole_serviceDesc, srv)
}
...
var _KGMSConsole_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "protobuf_v1/console.proto",
}

...
const (
	KGMSConsole_UserManagement_FullMethodName = "/KGMSConsole/UserManagement"
)
...
func (c *kGMSConsoleClient) UserManagement(ctx context.Context, opts ...grpc.CallOption) (KGMSConsole_UserManagementClient, error) {
	stream, err := c.cc.NewStream(ctx, &KGMSConsole_ServiceDesc.Streams[0], KGMSConsole_UserManagement_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
